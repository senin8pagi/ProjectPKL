...
<head>
  ...
  <title>Sistem Informasi M-Loket(ORANGER)</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>OrangerAdmin</b>App</span>
      </a>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="validasi.php">
              <i class="fa fa-address-book-o"></i> <span>VALIDASI REQUEST</span>
            </a>
          </li>

          <li>
            <a href="approval.php">
              <i class="fa fa-hand-paper-o"></i> <span>APPROVAL REQUEST</span>
            </a>
          </li>
          ...
          <li>
           ...
           <li>
            <a href="manifest.php">
              <i class="fa fa-eye"></i>  <span>PENGAWASAN MANIFEST</span>
            </a>
          </li>

          <li>
            <a href="setoran.php">
              <i class="fa fa-eye"></i>  <span>PENGAWASAN SETORAN</span>
            </a>
          </li>
