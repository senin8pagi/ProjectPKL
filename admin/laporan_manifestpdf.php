...
$pdf->Cell(280,7,'LAPORAN DATA MANIFEST',0,1,'C');
...
$pdf->Cell(10,7,'',0,1);
$pdf->Cell(35,6,'DESKRIPSI : DETAIL DATA MANIFEST',0,0);
$pdf->Cell(5,6,'',0,0);
...
$pdf->Cell(20,14, 'ID Produk' ,1,0,'C');
$pdf->Cell(35,14,'Jumlah Transaksi',1,0,'C');
$pdf->Cell(35,14,'Jumlah Uang',1,0,'C');
$pdf->Cell(30,14,'Tanggal',1,0,'C');
$pdf->Cell(35,14,'Nommor Backsheet',1,0,'C');
$pdf->Cell(35,14,'Barcode',1,0,'C');
$pdf->Cell(35,14,'No. Resi',1,0,'C');
...
$total_uang  = $d['nominal_tagihan'];
  ...
  $pdf->Cell(20,7, $d['jenis_id'] ,1,0,'C');
  if($d['jmlTrx']){
...
if($d['nominal_tagihan']){
  ...
  $pdf->Cell(35,7,$money,1,0,'C');

  $pdf->Cell(30,7,date('d-m-Y', strtotime($d['transaksi_tanggal'])),1,0,'C');
  $pdf->Cell(35,7, $d['billnumber'] ,1,0,'C');
  $pdf->Cell(35,7, $d['no_transaksi'] ,1,0,'C');
  $pdf->Cell(35,7, $d['no_resi'] ,1,1,'C');
