            ...
            <form method="get" action="">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    <br/>
                    <input type="submit" value="CEK DAFTAR SETORAN" class="btn btn-sm btn-primary btn-block">
                  </div>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_printsetoran.php?transaksi_tanggal=<?php echo $tgl_trx ?>&kprk=<?php echo $KPRK ?>&regional=<?php echo $regionalKode ?>" target="_blank" class="btn btn-sm btn-success"><i class="fa fa-print"></i> &nbsp PRINT</a>
